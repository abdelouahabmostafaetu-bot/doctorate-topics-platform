      ...
      <div className="mt-3 grid gap-3 sm:grid-cols-2">
        ...
        <div className="space-y-1 text-xs sm:col-span-2">
          ...
          <p className="text-[11px] text-muted-foreground">
            ضع الرابط والمفتاح ثم اضغط 📡 — تظهر النماذج المجانية فقط (المدفوعة والمتخصصة تُستبعد تلقائيًا)، والنماذج المعلّمة 👁 تصلح لمهمة قراءة الصور وPDF — التأكّد النهائي أن النموذج يعمل يتم عند الضغط على إضافة وفحص المفتاح
          </p>
        </div>
      </div>
